...
import "./style.css";
import pic1 from "../../assets/image-hybrid-event/pic1.png";
import pic2 from "../../assets/image-hybrid-event/pic2.png";
import pic3 from "../../assets/image-hybrid-event/pic3.png";
import pic4 from "../../assets/image-hybrid-event/pic4.png";
const HybridEvent = () => {
  const satu = pic1;
  const dua = pic2;
  const tiga = pic3;
        ...
        <div id="hybridAcordion" className="w-[75%] max-w-5xl mx-5 lg:mx-auto flex flex-col ">
          ...
          <div data-aos="fade-up" data-aos-duration="1000" className="flex justify-between xl:justify-center items-center">
            <div id="buttonHybridEvent" className="flex flex-col items-center w-full xl:w-[500px] justify-start  items-stretch xl:mr-0">
              ...
              >
                <p>Geotourism Fest & International Conference ...</p>
