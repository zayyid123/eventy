  ...
  return (
    <Fragment>
      <div className="bg-home-hybrid bg-customColor-biru justify-center flex items-center flex-col py-[6rem]">
        ...
        <buuton data-aos="fade-up" data-aos-delay="1500" data-aos-duration="1000" className="bg-white text-customColor-biruTua text-[20px] font-semibold px-[30px] py-1 rounded-xl">
          Detail Paket
        </buuton>
      </div>
    </Fragment>
