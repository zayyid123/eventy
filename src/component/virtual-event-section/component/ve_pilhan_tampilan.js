...
// img
import img2d from '../../../assets/icon-virtual-event/pilihan/img2d.png'
import img3d from '../../../assets/icon-virtual-event/pilihan/img3d.png'
    ...
    <div className='bg-white text-customColor-biruTua '>
      <div className='max-w-5xl mx-auto text-center'>
        ...
        <div className='flex flex-wrap'>
          <div data-aos="fade-right" data-aos-duration="1000" className='w-[100%] lg:w-1/2'>
          ...
          <div data-aos="fade-left" data-aos-duration="1000" className='w-[100%] lg:w-1/2'>
            <div className='mx-auto p-[16px] w-[70%] lg:w-[100%]'>
