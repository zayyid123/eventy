    ...
    <Fragment>
      <div className="bg-home-broadcast flex flex-col items-center w-full bg-customColor-biru pt-[60px]">
        <div data-aos="fade-up" data-aos-duration="1000" className="flex items-center flex-col px-[15px] md:w-[70%] ">
          ...
          <p className="text-white text-[20px] mb-[20px] text-center">Broadcasting by Evorty adalah layanan pendukung streaming event yang membantu mengatur tampilan output event virtual Anda agar terlihat lebih menarik dan profesional.</p>
        ...
        <div className="flex justify-center items-center py-[120px] flex-col">
          <img data-aos="fade-right" data-aos-duration="1000" src={img1} className="w-[70%] mb-[30px]" alt="broadcast 1" />
          <img data-aos="fade-left" data-aos-duration="1000" src={img2} className="w-[70%]" alt="broadcast 2" />
        </div>
      </div>
    </Fragment>
  );
