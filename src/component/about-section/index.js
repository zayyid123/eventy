        ...
        <div className='width-full max-w-5xl mx-auto pt-[80px] pb-[80px] text-center text-customColor-biruTua'>
            ...
            <div className='flex flex-wrap justify-center'>
                ...
                <div className='mr-[10px] ml-[10px]'>
                    <div 
                        className='w-[225px] h-[225px] relative overflow-hidden' 
                        onMouseEnter={() => setmyPlatform(true)}
                        onMouseLeave={() => setmyPlatform(false)}
                    >
                ...
                <div className='mr-[10px] ml-[10px]'>
                    <div 
                        className='w-[225px] h-[225px] relative overflow-hidden'
                        onMouseEnter={() => setmyHybird(true)}
                        onMouseLeave={() => setmyHybird(false)}
                        >
                ...
                <div className='mr-[10px] ml-[10px]'>
                    <div 
                        className='w-[225px] h-[225px] relative overflow-hidden'
                        onMouseEnter={() => setmySponsor(true)}
                        onMouseLeave={() => setmySponsor(false)}
                    >
                ...
                <div className='mr-[10px] ml-[10px]'>
                    <div 
                        className='w-[225px] h-[225px] relative overflow-hidden'
                        onMouseEnter={() => setmyBroadcast(true)}
                        onMouseLeave={() => setmyBroadcast(false)}
                    >
